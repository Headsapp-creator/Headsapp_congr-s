...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello {name},</p>
    <p>Welcome to HeadsApp Events! We're excited to have you on board.</p>
    <p>We're committed to providing you with the best experience possible. If you have any questions or need help, feel free to reach out to us.</p>
    <div style="text-align: center; margin: 30px 0;">
      <div style="background-color: #4CAF50; color: white; width: 50px; height: 50px; line-height: 50px; border-radius: 50%; display: inline-block; font-size: 30px;">
        ✔
      </div>
    </div>
    <p>As a reminder, here’s a quick overview of what you can do with our service:</p>
    <ul>
      <li>Create and manage events</li>
      <li>Connect with attendees</li>
      <li>Enjoy exclusive features and more!</li>
    </ul>
    <p>We're thrilled to be part of your journey. Let’s get started!</p>
    <p>Best regards,<br>Your HeadsApp Events Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
  </div>
...
export const WELCOME_EMAIL_WITH_CREDENTIALS_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #4CAF50, #4CAF49); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">Welcome to Our Service</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello {name},</p>
    <p>Welcome to HeadsApp Congrés! We're excited to have you on board.</p>
    <div style="background-color: #e8f5e9; border-left: 5px solid #4CAF50; padding: 16px; margin: 24px 0; border-radius: 5px;">
      <p style="margin: 0 0 8px 0;"><strong>Your account has been created. Here are your credentials:</strong></p>
      <div style="font-size: 1.1em;">
        <span style="display:inline-block; min-width:90px; color:#4CAF50; font-weight:bold;">Email:</span> <span style="font-family: monospace;">{email}</span><br>
        <span style="display:inline-block; min-width:90px; color:#4CAF50; font-weight:bold;">Password:</span> <span style="font-family: monospace;">{password}</span>
      </div>
    </div>
    <p style="color: #d32f2f;"><strong>For your security, please log in and change your password as soon as possible.</strong></p>
    <p>We're thrilled to be part of your journey. Let’s get started!</p>
    <p>We're committed to providing you with the best experience possible. If you have any questions or need help, feel free to reach out to us.</p>
    <p>Best regards,<br>Your HeadsApp Congrés Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
  </div>
